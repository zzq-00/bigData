  ...
  <div class="cost-index-page">
    <div class="tab-control">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="单项工程指标汇总表" name="1"></el-tab-pane>
        <el-tab-pane label="分部工程经济指标" name="2"></el-tab-pane>
        <el-tab-pane label="分部工程技术指标" name="3"></el-tab-pane>
        <el-tab-pane label="分部分项及单价措施技经指标表" name="4"></el-tab-pane>
        <el-tab-pane label="人材机汇总表" name="5"></el-tab-pane>
        <el-tab-pane label="主要人材机消耗量表" name="6"></el-tab-pane>
      </el-tabs>
      <div class="separated" v-if="activeName=='4'||monomerInfo.name"></div>
      <div class="option">
        <div class="drop-down" v-if="activeName=='4'">
          <!-- 只有分部分析 显示选择范围 -->
    ...
    <keep-alive>
      <individual v-if='activeName == "1"'></individual>
      <economics v-if='activeName == "2"'></economics>
      <technology v-if='activeName == "3"'></technology>
      <unitPrice v-if='activeName == "4"' @changeLevel="changeLevel" :command='command'></unitPrice>
      <personnelMachine v-if='activeName == "5"'></personnelMachine>
      <consumption v-if='activeName == "6"'></consumption>
    </keep-alive>
...
import personnelMachine from './CostIndex/personnelMachine' //人材机
