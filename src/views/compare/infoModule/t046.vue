...
<template>
  <div class="li-box">
    <div v-if="$props.info=='true'">
      ...
      <li>
        <span>地下层数:</span>
        <span>{{ruleForm.monomerAll.deitail.undergroundFloors}}层</span>
      </li>
      <li>
        <span>总客房数:</span>
        <span>{{ruleForm.monomerAll.deitail.totalRooms}}间</span>
      </li>
      <li>
        <span>大堂面积:</span>
        <span>{{ruleForm.monomerAll.deitail.lobbyArea}}㎡</span>
      </li>
    </div>
    <div v-else>
      <li>
      ...
      <li>
        <el-form-item label="总客房数(间):">
          <el-col :span="11">
            <el-form-item prop="totalRooms1">
              <el-input class="short-input" v-model="ruleForm.totalRooms1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="totalRooms2">
              <el-input class="short-input" v-model="ruleForm.totalRooms2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
      ...
      <li>
        <el-form-item label="大堂面积(㎡):">
          <el-col :span="11">
            <el-form-item prop="lobbyArea1">
              <el-input class="short-input" v-model="ruleForm.lobbyArea1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="lobbyArea2">
              <el-input class="short-input" v-model="ruleForm.lobbyArea2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
