...
<template>
  <div class="li-box">
    <div v-if="$props.info=='true'">
      ...
      <li>
        <span>床位数:</span>
        <span>{{ruleForm.monomerAll.deitail.bedNumber}}位</span>
      </li>
    </div>
    <div v-else>
      <li>
      ...
      <li>
        <el-form-item label="床位数(位):">
          <el-col :span="11">
            <el-form-item prop="bedNumber1">
              <el-input class="short-input" v-model="ruleForm.bedNumber1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="bedNumber2">
              <el-input class="short-input" v-model="ruleForm.bedNumber2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
