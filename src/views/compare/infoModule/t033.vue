...
<template>
  <div class="li-box">
    <div v-if="$props.info=='true'">
      ...
      <li>
        <span>檐高(或建筑高度):</span>
        <span>{{ruleForm.monomerAll.deitail.eavesHeight}}m</span>
      </li>
    </div>
    <div v-else>
      <li>
      ...
      <li>
        <el-form-item label="檐高(或建筑高度)(m):" class="special-item">
          <el-col :span="11">
            <el-form-item prop="eavesHeight1">
              <el-input class="short-input" v-model="ruleForm.eavesHeight1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="eavesHeight2">
              <el-input class="short-input" v-model="ruleForm.eavesHeight2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
