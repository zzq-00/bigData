...
<template>
  <div class="li-box">
    <div v-if="$props.info=='true'">
      ...
      <li>
        <span>门诊面积:</span>
        <span>{{ruleForm.monomerAll.deitail.outpatientArea}}㎡</span>
      </li>
      <li>
        <span>手术室面积:</span>
        <span>{{ruleForm.monomerAll.deitail.operatingArea}}㎡</span>
      </li>
    </div>
    <div v-else>
      <li>
      ...
      <li>
        <el-form-item label="手术室面积(㎡):">
          <el-col :span="11">
            <el-form-item>
              <el-input class="short-input" v-model="ruleForm.operatingArea1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item>
              <el-input class="short-input" v-model="ruleForm.operatingArea2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
      ...
      <li>
        <el-form-item label="门诊面积(㎡):">
          <el-col :span="11">
            <el-form-item>
              <el-input class="short-input" v-model="ruleForm.outpatientArea1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item>
              <el-input class="short-input" v-model="ruleForm.outpatientArea2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
