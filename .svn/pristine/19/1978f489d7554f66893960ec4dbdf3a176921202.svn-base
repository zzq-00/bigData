...
<template>
  <div class="li-box">
    <div v-if="$props.info=='true'">
      ...
      <li>
        <span>装配率:</span>
        <span>{{ruleForm.monomerAll.deitail.assemblyRate}}%</span>
      </li>
      <li>
        <span>是否含底层商铺:</span>
        <span>{{ruleForm.monomerAll.deitail.ifDishang?'含':'不含'}}</span>
      </li>
    </div>
    <div v-else>
      <li>
      ...
      <li>
        <el-form-item label="装配率(%):">
          <el-col :span="11">
            <el-form-item prop="assemblyRate1">
              <el-input class="short-input" v-model="ruleForm.assemblyRate1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="assemblyRate2">
              <el-input class="short-input" v-model="ruleForm.assemblyRate2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
      ...
      <li>
        <el-form-item label="是否含底层商铺：" prop="ifDishang" class="special-item">
          <el-select v-model="ruleForm.ifDishang" placeholder="是否含底层商铺：">
