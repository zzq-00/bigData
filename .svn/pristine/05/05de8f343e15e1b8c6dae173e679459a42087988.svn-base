<template>
  <div>
    ...
    <el-form-item label="结构类型：" prop="structureTypeId">
      <el-radio-group v-model="ruleForm.structureTypeId">
    ...
    <div style="display: flex;justify-content: space-between;">
      ...
      <el-form-item label="班级人数：" prop='classSize'>
        <el-input class="short-input" v-model="ruleForm.classSize"></el-input>人
      </el-form-item>
    </div>
    <div style="display: flex;justify-content: space-between;">
    ...
    <div style="display: flex;justify-content: space-between;">
      <el-form-item label="地上层数：" prop="groundFloors">
    ...
    <el-form-item label="学制：" prop="educationalSystem">
      <el-checkbox-group v-model="ruleForm.educationalSystem">
        <el-checkbox name="type" v-for='(item,index) in educationalSystemData' :key='index' :label="item.id">{{item.name}}</el-checkbox>
      </el-checkbox-group>
    </el-form-item>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    if (!this.ruleForm.educationalSystem) {
      this.ruleForm.educationalSystem = []
    }
  },
  methods: {
    structureTypeFn() {
