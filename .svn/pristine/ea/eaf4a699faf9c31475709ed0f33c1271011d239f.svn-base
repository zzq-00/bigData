...
<template>
  <div class="li-box">
    <div v-if="$props.info=='true'">
      ...
      <li>
        <span>商业面积:</span>
        <span>{{ruleForm.monomerAll.deitail.commercialArea}}㎡</span>
      </li>
      <li>
        <span>办公面积:</span>
        <span>{{ruleForm.monomerAll.deitail.workArea}}㎡</span>
      </li>
      <li>
        <span>住宅面积:</span>
        <span>{{ruleForm.monomerAll.deitail.residentialArea}}㎡</span>
      </li>
    </div>
    <div v-else>
      <li>
      ...
      <li>
        <el-form-item label="商业面积(㎡):">
          <el-col :span="11">
            <el-form-item prop="commercialArea1">
              <el-input class="short-input" v-model="ruleForm.commercialArea1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="commercialArea2">
              <el-input class="short-input" v-model="ruleForm.commercialArea2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
      ...
      <li>
        <el-form-item label="办公面积(㎡):">
          <el-col :span="11">
            <el-form-item prop="workArea1">
              <el-input class="short-input" v-model="ruleForm.workArea1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="workArea2">
              <el-input class="short-input" v-model="ruleForm.workArea2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
      ...
      <li>
        <el-form-item label="住宅面积(㎡):">
          <el-col :span="11">
            <el-form-item prop="residentialArea1">
              <el-input class="short-input" v-model="ruleForm.residentialArea1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="residentialArea2">
              <el-input class="short-input" v-model="ruleForm.residentialArea2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
