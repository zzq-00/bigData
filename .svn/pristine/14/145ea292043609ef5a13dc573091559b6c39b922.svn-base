<template>
  <div>
    ...
    <div style="display: flex;justify-content: space-between;">
      <!-- 非必填 -->
      <el-form-item label="总客房数：" prop="totalRooms">
        <el-input class="short-input" v-model="ruleForm.totalRooms"></el-input>间
      </el-form-item>
      <el-form-item label="大堂面积：" prop="lobbyArea">
        <el-input class="short-input" v-model="ruleForm.lobbyArea"></el-input>㎡
      </el-form-item>
    </div>
  </div>
</template>
