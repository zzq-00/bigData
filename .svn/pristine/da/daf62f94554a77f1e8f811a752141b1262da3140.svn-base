  ...
  <div>
    ...
    <div style="display: flex;justify-content: space-between;">
      ...
      <el-form-item label="商业面积：" prop="commercialArea">
        <el-input class="short-input" v-model="ruleForm.commercialArea"></el-input>㎡
      </el-form-item>
    </div>
    <div style="display: flex;justify-content: space-between;">
      <el-form-item label="办公面积：" prop="workArea">
        <el-input class="short-input" v-model="ruleForm.workArea"></el-input>㎡
      </el-form-item>
      <el-form-item label="住宅面积：" prop="residentialArea">
        <el-input class="short-input" v-model="ruleForm.residentialArea"></el-input>㎡
      </el-form-item>
    </div>
  </div>
</template>
