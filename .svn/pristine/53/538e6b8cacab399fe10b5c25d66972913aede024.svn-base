<template>
  <div>
    ...
    <el-form-item label="建筑风格：" prop="style">
      <!-- 非必填-->
      <el-input type="textarea" v-model="ruleForm.style" show-word-limit maxlength="100"></el-input>
    </el-form-item>
  </div>
</template>
...
export default {
  ...
  methods: {
    // rendering () {
    //     console.log(this.$props.ruleForm.secondradio,this.$props.ruleForm.thirdradio,'secondradio');
    // },
    structureTypeFn() {
