<template>
  <div class="li-box">
    <div v-if="$props.info=='true'">
      ...
      <li>
        <span>建筑面积:</span>
        <span>{{ruleForm.monomerAll.deitail.buildArea}}㎡</span>
      </li>
      <li>
        <span>层数:</span>
        <span>{{ruleForm.monomerAll.deitail.floors}}层</span>
      </li>
      <li>
        <span>车位数:</span>
        <span>{{ruleForm.monomerAll.deitail.numberOfCars}}个</span>
      </li>
    </div>
    <div>
      <li>
      ...
      <li>
        <el-form-item label="建筑面积(㎡):" class="special-item">
          <el-col :span="11">
      ...
      <li>
        <el-form-item label="层数(层):">
          <el-col :span="11">
            <el-form-item prop="floors1">
              <el-input class="short-input" v-model="ruleForm.floors1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="floors2">
              <el-input class="short-input" v-model="ruleForm.floors2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
      ...
      <li>
        <el-form-item label="车位数(个):">
          <el-col :span="11">
            <el-form-item prop="numberOfCars1">
              <el-input class="short-input" v-model="ruleForm.numberOfCars1">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="numberOfCars2">
              <el-input class="short-input" v-model="ruleForm.numberOfCars2">
              </el-input>
            </el-form-item>
          </el-col>
        </el-form-item>
